	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 col-12 mt-5 mt-lg-0">
				...
				<p>
					송유선 강사님은 통계적 방법론과 데이터 분석 분야에서 15년 이상의 경력을 보유한 전문가입니다. 이론과 실습을 병행하며 학생들에게 통계학의 중요성과 실제 활용 능력을 가르칩니다.
				</p>
				<p>
					본 강의는 통계학에 대한 흥미를 고취시키고, 학생들이 학문 및 산업 현장에서 탁월한 성과를 낼 수 있도록 돕는 것을 목표로 합니다.
				</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-12">
				...
				<p>
					Q&A 또는 아래 정보를 통해 문의하실 수 있습니다 :
				</p>
				<p>
					<i class="bi-geo-alt me-2"></i> 서울, 대한민국
				</p>
				<p>
					<a href="tel:010-1234-5678" class="contact-link">010-1234-5678</a>
				</p>
				<p>
					<a href="mailto:professor@example.com" class="contact-link">pipe@naver.com</a>
				</p>
			</div>
		</div>
	</div>
